...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/04/2024 às 15:38
...
--
-- Estrutura para tabela `linha_d0_tempo`
--

CREATE TABLE `linha_d0_tempo` (
  `id` int(11) NOT NULL,
  `nome` varchar(255) NOT NULL,
  `descricao` varchar(255) NOT NULL,
  `id_projeto` int(11) NOT NULL
...
--
-- Índices de tabela `linha_d0_tempo`
--
ALTER TABLE `linha_d0_tempo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `linha_d0_tempo`
--
ALTER TABLE `linha_d0_tempo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
